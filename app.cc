...
using namespace std;
 ...
 rep->ifEShiftHist(true);//new edited point
 rep->setEShiftHist("Escalefraction.root");//new edited point
 // *******************************************************************************************
 // ******************************************************************************************* 
 ...
 if (!rep->getIfEShiftHist())//new edited point
   rep->getParVar(11)->setConstant(true);
 else
   rep->getParVar(11)->setConstant(false);
